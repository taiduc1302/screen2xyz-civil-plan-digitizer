...
Run one **owner-authorized real civil takeoff validation session** using a private/local drawing already being manually reviewed by the estimator, with Sheet 03 of the current King Road workflow as the preferred first case if project-data handling permits.
