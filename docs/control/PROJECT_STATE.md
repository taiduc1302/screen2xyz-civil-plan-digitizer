...
- No authorized proprietary King Road sheet is committed as CI evidence. Real-plan quantity/coverage accuracy remains unknown until private owner-machine acceptance.
...
The next task is no longer more generic architecture. It is a private owner-machine acceptance on King Road Sheet 03:
