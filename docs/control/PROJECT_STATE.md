...
KingRoad_TAKEOFF_WORKING.pdf   editable Revu working copy
KingRoad_S03.s2a.json          proposal/audit/session state
```
...
- No proprietary King Road sheet is committed as CI evidence; real-plan quantity/coverage accuracy remains unknown until private acceptance.
...
The next task is a private owner-machine King Road Sheet 03 acceptance:
