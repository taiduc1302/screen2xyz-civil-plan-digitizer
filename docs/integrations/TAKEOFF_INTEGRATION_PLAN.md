...
The first deterministic rules are based on the current estimator-reviewed King Road examples:
...
- Add deterministic tests including King Road-style cases.
...
5. Real King Road/Bluebeam comparison remains an external estimator-validation gate and is not committed to this private repo unless the owner explicitly authorizes the source material.
