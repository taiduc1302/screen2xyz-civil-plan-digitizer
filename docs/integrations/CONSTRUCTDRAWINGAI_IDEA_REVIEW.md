...
This directly supports cases already observed in the Example Road review such as `PARTIAL` ditch reaches, mixed regrade/relocation traces, and obscured culvert endpoints.
