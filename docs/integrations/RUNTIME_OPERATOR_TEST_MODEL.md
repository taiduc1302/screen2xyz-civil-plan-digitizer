...
- no real King Road/Bluebeam gold-set comparison is recorded as an automated validation gate.
...
King Road Sheet 03 should be the first acceptance set because it already contains line, polygon, anchor, partial/mixed scope, culvert, shoulder, driveway, and ditch cases.
...
6. a private King Road/Bluebeam gold-set run has no critical invariant failure and no silent miss for the agreed scope;
